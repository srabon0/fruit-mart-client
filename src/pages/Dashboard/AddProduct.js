  ...
  return (
    <div className="max-w-2xl mx-auto">
      <form onSubmit={addFruit}>
        ...
        <input
          type="submit"
          className="text-white bg-orange-600 hover:bg-orange-40 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center "
          value="Add Fruit"
        />
      </form>
    </div>
