    ...
    <div className="col-span-2">
      <div className="flex flex-col justify-between h-screen bg-white border-r">
        <div className="px-4 py-6">
          <p className="block w-32 h-10 bg-gray-200 rounded-lg text-lg font-bold px-1 py-1">Dashboard</p>
          ...
          <NavLink
            ...
            >
              <p className="flex items-center px-4 py-2 text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700">
              <svg
          ...
          <NavLink
             to='/dashboard/orders'
            >
              <p className="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg">
