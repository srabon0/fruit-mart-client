...
const ProductDetails = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={picture} />
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">FRUITMART + {id}</h2>
        ...
        <div class="flex">
          <span class="title-font font-medium text-2xl text-gray-900">Unit Price:$ {price} </span>
          <button class="flex ml-auto text-white bg-orange-600 border-0 py-2 px-6 focus:outline-none rounded">Add to Cart</button>
