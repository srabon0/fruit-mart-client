...
const Sidebar = () => {
  return (
    ...
    //     <li>
    //       <NavLink to='/dashboard'>Product list</NavLink>
    //     </li>
    ...
    //       </li>
    //       <li>
    //         <NavLink to='/dashboard/payment' >Payment Method</NavLink>
    //       </li>
    //       <li>
    ...
    <div class="col-span-2">
      <div class="flex flex-col justify-between h-screen bg-white border-r">
        <div class="px-4 py-6">
          <p class="block w-32 h-10 bg-gray-200 rounded-lg text-lg font-bold px-1 py-1">Dashboard</p>
          ...
          <NavLink
            ...
            >
              <p class="flex items-center px-4 py-2 text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700">
              <svg
              ...
              <span class="ml-3 text-sm font-medium">Product List </span>
              </p>
          </NavLink>
          ...
          <NavLink
             to='/dashboard/orders'
            >
              <p class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg">
          ...
          <NavLink
            ...
            >
              ...
              <span class="ml-3 text-sm font-medium"> Add Product </span>
              </p>
          </NavLink>
          ...
          <NavLink
            ...
            >
              ...
              <span class="ml-3 text-sm font-medium"> Back to home </span>
              </p>
          </NavLink>
